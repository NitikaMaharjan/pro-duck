  ...
  return (
    <div style={{width: "100%", display: "flex", alignItems: "center", justifyContent: "space-between"}}>
      ...
      <div style={{display: "flex", alignItems: "center", gap: "8px"}}>
        ...
        <div className={`theme-change-button${theme==="light"?"-light":"-dark"}`} onClick={()=>ChangeTheme()}>
          <img src={theme==="light"?"/icons/moon.png":"/icons/sun.png"} height="20px" width="20px" alt="theme icon"/>
        </div>
      </div>
    </div>
  )
